# Implementación de un proyecto de sistema clientes CRUD (CRM), aplicando el concepto de Programación orientada a objetos (POO), y una "base de datos" IndexedDB.
